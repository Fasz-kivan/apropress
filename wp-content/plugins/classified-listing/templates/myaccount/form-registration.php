	...
	<?php if ( Functions::is_registration_enabled() && Functions::is_registration_page_separate() ): ?>
        <div class="rtcl-registration-form-wrap">
			...
			<div class="form-check">
				<input id="rtcl-newsletter" name="newsletter" type="checkbox" class="form-check-input" >
				<label class="form-check-label" for="rtcl-newsletter"> Felíratkozok a hírlevélre </label>
			</div>
