...
class Gallery
{
    ...
    static function rtcl_gallery_content($post = null, $conf = array()) {
        ...
        $picture_limit_query = $wpdb->get_row($wpdb->prepare( "SELECT * FROM {$table} WHERE user_id = %d", $cuser_id ));
        $max_image_limit=$picture_limit_query->picture_limit;
        ...
        <div class="form-group">
            <div id="rtcl-gallery-upload-ui-wrapper"
                ...
                <div class="description alert alert-danger">
                    ...
                    printf(
                        __('<p>A feltölteni kívánt képeket a <a href="https://squoosh.app/" target="_blank">squoosh.app</a> oldalon tudod tömöríteni.</p>', "classified-listing")
                    );
                    ?>
                </div>
