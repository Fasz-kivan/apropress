...
$rocket_cookie_hash = '5e8ac1498a3fb9be594787d3627bd010';
$rocket_logged_in_cookie = 'wordpress_logged_in_5e8ac1498a3fb9be594787d3627bd010';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?.+/?|/(?:.+/)?embed/|/kosar/(.*)|/kosar-2/|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)|/kezelofelulet/';
